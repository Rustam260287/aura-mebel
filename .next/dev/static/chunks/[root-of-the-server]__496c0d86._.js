...
const getVisualRecommendations = async (base64Image, mimeType, products)=>{
    ...
    // --- ИЗМЕНЕНИЕ: Промпт теперь просит вернуть индексы ---
    const textPart = {
    ...
    const handleSubmit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "VisualSearchPage.useCallback[handleSubmit]": async ()=>{
            ...
            try {
                ...
                // --- ИЗМЕНЕНИЕ: Получаем массив индексов ---
                ...
                if (recommendedIndices.length === 0) {
                    ...
                    // --- ИЗМЕНЕНИЕ: Находим товары по индексам ---
                    ...
                    }["VisualSearchPage.useCallback[handleSubmit].foundProducts"]).filter(Boolean); // Фильтруем на случай, если AI вернет неверный индекс
...
_s(VisualSearchPage, "Tsg5fqbGOab7wuT39CAy10v1qSc=");
_c = VisualSearchPage;
var _c;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__496c0d86._.js.map