...
// --- ИСПРАВЛЕНИЕ: Возвращаем рабочую модель gemini-2.5-pro ---
...
const getVisualRecommendations = async (base64Image, mimeType, products)=>{
    ...
    const textPart = {
        text: `Проанализируй фото. Вот нумерованный список товаров:\n${productList}\n\nВыбери 3-5 наиболее подходящих товаров. Верни ТОЛЬКО JSON-массив с числами (индексами) из предоставленного списка. Пример: [0, 5, 12]`
    };
    try {
        ...
        console.error('[getVisualRecommendations] CRITICAL ERROR:', error);
        throw error;
    }
};
const getStyleRecommendations = async (prompt, products)=>Promise.resolve([]);
const generateRoomMakeover = async (base64Image, mimeType, style, products)=>Promise.resolve({
        generatedImage: '',
...
const VisualSearchPage = ({ allProducts, onProductSelect })=>{
    ...
    const handleFile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "VisualSearchPage.useCallback[handleFile]": (file)=>{
            if (file && file.type.startsWith('image/')) {
                ...
                const reader = new FileReader();
                reader.onloadend = ({
                    "VisualSearchPage.useCallback[handleFile]": ()=>setImagePreview(reader.result)
    ...
    const handleFileChange = (e)=>handleFile(e.target.files?.[0] || null);
    ...
    const handleSubmit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "VisualSearchPage.useCallback[handleSubmit]": async ()=>{
            ...
            try {
                ...
                const recommendedIndices = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$geminiService$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["getVisualRecommendations"])(base64Image, imageFile.type, allProducts);
                if (recommendedIndices.length === 0) {
                    setError('Не смогли найти подходящую мебель.');
                } else {
                    const foundProducts = recommendedIndices.map({
                        "VisualSearchPage.useCallback[handleSubmit].foundProducts": (index)=>allProducts[index]
                    }["VisualSearchPage.useCallback[handleSubmit].foundProducts"]).filter(Boolean);
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-lg text-brand-charcoal mb-8",
                        children: "Загрузите фото интерьера, и наш ИИ-стилист подберет похожую мебель."
                    }, void 0, false, {
                        fileName: "[project]/components/VisualSearchPage.tsx",
                        lineNumber: 79,
                        columnNumber: 9
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    !imagePreview ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                        ...
                        onDrop: handleDrop,
                        className: `flex justify-center w-full h-64 px-6 pt-5 pb-6 border-2 ${isDragOver ? 'border-brand-brown' : 'border-gray-300'} border-dashed rounded-md cursor-pointer`,
...
_s(VisualSearchPage, "hQBzj6WlQ3eJUvDLV7EIoGCg3Hc=");
_c = VisualSearchPage;
var _c;
__turbopack_context__.k.register(_c, "VisualSearchPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0b73d5fb._.js.map