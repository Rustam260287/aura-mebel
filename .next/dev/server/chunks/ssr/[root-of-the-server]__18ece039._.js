...
function HomePage({ allProducts }) {
    ...
    // onNavigate больше не нужен в пропсах Header
    const handleNavigate = (view)=>{
        switch(view.page){
            case 'catalog':
                router.push(view.category ? `/catalog?category=${view.category}` : '/catalog');
                break;
            // Добавим другие маршруты, если понадобится
            default:
                router.push('/');
        }
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__18ece039._.js.map