...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/router.js [ssr] (ecmascript)"); // <-- Импортируем роутер
;
;
;
...
function HomePage({ allProducts }) {
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["useRouter"])(); // <-- Инициализируем роутер
    // ... (useState остается без изменений)
    // --- ИСПРАВЛЕНИЕ: Используем роутер для навигации ---
    const handleNavigate = (view)=>{
        if (view.page === 'product') {
            router.push(`/products/${view.productId}`);
        } else {
            // TODO: Добавить логику для других страниц
