...
const getStyleRecommendations = async (prompt, products)=>{
    ...
    const response = await ai.models.generateContent({
        ...
        config: {
            ...
            responseSchema: {
                type: __TURBOPACK__imported__module__$5b$externals$5d2f40$google$2f$genai__$5b$external$5d$__$2840$google$2f$genai$2c$__esm_import$29$__["Type"].ARRAY,
                items: {
                    type: __TURBOPACK__imported__module__$5b$externals$5d2f40$google$2f$genai__$5b$external$5d$__$2840$google$2f$genai$2c$__esm_import$29$__["Type"].STRING
                }
            }
        }
    });
...
const generateRoomMakeover = async (base64Image, mimeType, style, products)=>{
    const imageGenResponse = await ai.models.generateContent({
        ...
        config: {
            responseModalities: [
                __TURBOPACK__imported__module__$5b$externals$5d2f40$google$2f$genai__$5b$external$5d$__$2840$google$2f$genai$2c$__esm_import$29$__["Modality"].IMAGE
            ]
        }
    });
...
const generateStagedImage = async (product, roomBase64, roomMimeType)=>{
    const { base64: productBase64, mimeType: productMimeType } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["imageUrlToBase64"])(product.imageUrls[0]);
    const response = await ai.models.generateContent({
        model: imageModel,
        contents: {
            parts: [
...
const analyzeChatLogs = async (chatLogs)=>{
    ...
    const response = await ai.models.generateContent({
        ...
        config: {
            responseMimeType: 'application/json',
            responseSchema: {
                type: __TURBOPACK__imported__module__$5b$externals$5d2f40$google$2f$genai__$5b$external$5d$__$2840$google$2f$genai$2c$__esm_import$29$__["Type"].OBJECT,
                properties: {
                    actionableInsights: {
                        type: __TURBOPACK__imported__module__$5b$externals$5d2f40$google$2f$genai__$5b$external$5d$__$2840$google$2f$genai$2c$__esm_import$29$__["Type"].ARRAY,
                        items: {
...
;
;
const VisualSearchPage = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["memo"])(({ allProducts, onProductSelect })=>{
    ...
    const handleRemoveImage = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useCallback"])(()=>{
        setImageFile(null);
    ...
    const handleSubmit = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useCallback"])(async ()=>{
        ...
        try {
            ...
            const recommendedNames = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$geminiService$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getVisualRecommendations"])(base64Image, imageFile.type, allProducts);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            recommendedProducts.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                className: "mt-16",
                children: [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$VisualSearchPage$2e$tsx__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/VisualSearchPage.tsx [ssr] (ecmascript)"); // Используем ваш существующий компонент
...
//# sourceMappingURL=%5Broot-of-the-server%5D__793dd968._.js.map