    ...
    <div className="bg-brand-cream-dark min-h-screen pb-20">
      ...
      <div className="bg-brand-brown text-white py-16 md:py-32 relative overflow-hidden">
        <div className="absolute inset-0 opacity-20">
             <Image src="https://images.unsplash.com/photo-1497366216548-37526070297c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1600&q=80" alt="bg" fill className="object-cover" />
        </div>
        <div className="absolute inset-0 bg-gradient-to-r from-brand-brown via-brand-brown/90 to-brand-brown/40"></div>
                ...
                <div>
                    ...
                    <div className="mt-12 pt-8 border-t border-gray-100 space-y-4">
                        ...
                        <div className="flex items-center gap-5">
                            ...
                            <a href="mailto:hello@labelcom.store" className="text-lg text-brand-charcoal hover:text-brand-terracotta transition-colors">hello@labelcom.store</a>
                        </div>
                    </div>
                </div>
